          ...
          <div className="flex flex-wrap">
            <div className="lg:w-1/3 w-full p-5">
              <div className="w-full h-full p-3">
                <img src={url + '/public/uploads/' + logo} alt="" className=" lg:max-w-[100%] w-[200px] block bg-white rounded-lg lg:me-auto me-auto" />
            ...
            <div className="lg:w-2/3  w-full p-5">
              <div className="flex flex-wrap pb-[4rem] mb-[3rem] ">
